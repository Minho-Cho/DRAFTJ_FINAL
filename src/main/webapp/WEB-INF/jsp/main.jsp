		...
		$.ajax({
			...
			complete : function(result) {
				...
				if (result.responseText.indexOf("redirect") != -1) {
					insertChat("me", "<p>7-25 오후2시-3시 / 701호<p>예약완료!");
					openPage(event,'divSchedule');
				}
				else if (result.responseText.indexOf("study")== 0){
					replaceWord();
				}
				else {
...
<body>
	<header>
		<h2 style="margin-left: 10px;">Meeting Assistant(회의봇)</h2>
	</header>
...
<!-- 										<td class="info" style="width: 35%;">701호</td> -->
										<th class="info" style="width: 15%;">일시</th>
										<td class="info" style="width: 35%;">2018-08-14</td>
										<th class="info" style="width: 15%;">장소</th>
										<td class="info" style="width: 35%;">Vision Room</td>
									</tr>
									<tr class="info">
										<th class="info" style="width: 15%;">참석자</th>
										<td class="info" style="width: 35%;" colspan="3">부문</td>
									</tr>
								</table>
							</div>
						</td>
